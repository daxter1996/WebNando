    ...
    <div class="container">
        <div class="row">
            <div class="col m6 s12 white-text">
                <h5>Blue Beach</h5>
                <p><?php echo $textos["telefono"][$lang] ?>: <strong style="color: white;"><a href="tel:+0034685670969"> 685 670 969</a></strong></p>
<!--                <p><strong style="color: white;">Prefijo internacional 0034</strong></p>-->
            ...
            <div class="col m4 offset-l2 s12">
                <ul>
                    ...
                    <img src="img/logo_rentalia.png" style="height: 71px; border-radius: 8px">
                    <img src="img/airbnb.jpg" style="height: 71px; border-radius: 8px">
                    <img src="img/tripadvisor.jpeg" style="height: 71px; border-radius: 8px">
                </ul>
            </div>
        </div>
    </div>
